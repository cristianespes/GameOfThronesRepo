...
extension LocalFactory: SeasonFactory {
    ...
    var seasons: [Season] {
        ...
        dateString = "05/08/2011"
        dateFromString = dateStringFormatter.date(from: dateString)
        dateStringFormatter.timeZone = TimeZone(secondsFromGMT:0)
        let date4s1 = dateFromString!
        
        dateString = "05/15/2011"
        dateFromString = dateStringFormatter.date(from: dateString)
        dateStringFormatter.timeZone = TimeZone(secondsFromGMT:0)
        let date5s1 = dateFromString!
        
        dateString = "05/22/2011"
        dateFromString = dateStringFormatter.date(from: dateString)
        dateStringFormatter.timeZone = TimeZone(secondsFromGMT:0)
        let date6s1 = dateFromString!
        
        dateString = "05/29/2011"
        dateFromString = dateStringFormatter.date(from: dateString)
        dateStringFormatter.timeZone = TimeZone(secondsFromGMT:0)
        let date7s1 = dateFromString!
        
        dateString = "06/05/2011"
        dateFromString = dateStringFormatter.date(from: dateString)
        dateStringFormatter.timeZone = TimeZone(secondsFromGMT:0)
        let date8s1 = dateFromString!
        
        dateString = "06/12/2011"
        dateFromString = dateStringFormatter.date(from: dateString)
        dateStringFormatter.timeZone = TimeZone(secondsFromGMT:0)
        let date9s1 = dateFromString!
        
        dateString = "06/19/2011"
        dateFromString = dateStringFormatter.date(from: dateString)
        dateStringFormatter.timeZone = TimeZone(secondsFromGMT:0)
        let date10s1 = dateFromString!
